...
/**
 * State holder for [PinchResizeGrid].
 *
 ...
 */
@Stable
public class PinchResizeGridState(
    initialColumnCount: Int = PinchResizeGridDefaults.InitialColumnCount,
    public val minColumns: Int = PinchResizeGridDefaults.MinColumns,
    public val maxColumns: Int = PinchResizeGridDefaults.MaxColumns,
) {
    init {
    ...
    public companion object {
        /**
         * [Saver] for [PinchResizeGridState] to survive configuration changes.
         */
        public fun Saver(minColumns: Int, maxColumns: Int): Saver<PinchResizeGridState, Int> =
            Saver(
                save = { it.columnCount },
                restore = { saved ->
                    PinchResizeGridState(
...
/**
 * Creates and remembers a [PinchResizeGridState] that survives configuration changes.
 */
@Composable
public fun rememberPinchResizeGridState(
    initialColumnCount: Int = PinchResizeGridDefaults.InitialColumnCount,
    minColumns: Int = PinchResizeGridDefaults.MinColumns,
    maxColumns: Int = PinchResizeGridDefaults.MaxColumns,
): PinchResizeGridState {
    return rememberSaveable(
        saver = PinchResizeGridState.Saver(minColumns, maxColumns),
    ) {
        PinchResizeGridState(
