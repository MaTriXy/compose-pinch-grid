...
| `dokar3/pinch-zoom-grid` | Android-only. Java. Not maintained. No KMP. |
| **PinchGrid** | Raw `pointerInput` — only consumes when 2+ fingers detected. Single-finger scroll passes through untouched. KMP from day one. |
